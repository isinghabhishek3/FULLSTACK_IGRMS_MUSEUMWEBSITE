  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "http://localhost:3001/api/stuffs/addstuffs",
        {
          method: "POST",
          headers: {
      ...
      if (response.ok) {
        ...
        // Hide success message and show the full form again after 2 seconds
        setTimeout(() => {
      ...
      `}</style>
        {showSuccessMessage ? (
          <div className="container">
            <div className="heading" style={{color:"white"}}>Form Submitted Successfully</div>
          </div>
        ) : (
          <div className="container" >
            <div
